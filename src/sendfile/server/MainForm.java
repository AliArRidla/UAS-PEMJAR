...
public class MainForm extends javax.swing.JFrame {
        ...
        for(int x=0; x < clientFileSharingUsername.size(); x++){
            if(clientFileSharingUsername.elementAt(x).equals(username)){
                try {
                    ...
                    appendMessage("[FileSharing]: Membatalkan "+ username);
                } catch (IOException e) {
                    appendMessage("[FileSharing]: "+ e.getMessage());
                    appendMessage("[FileSharing]: Tidak dapat membatalkan "+ username);
                }
                break;
            }
        }
    ...
    private void initComponents() {
        ...
        jTextArea1.setBackground(new java.awt.Color(139, 234, 185));
        jTextArea1.setColumns(20);
        jTextArea1.setRows(5);
        jScrollPane1.setViewportView(jTextArea1);

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/sendfile/server/chat.png"))); // NOI18N

        jLabel3.setFont(new java.awt.Font("Lucida Grande", 1, 24)); // NOI18N
        jLabel3.setText("App Chat Sederhana ");

        jLabel4.setText("yang penting bisa kirim file");
