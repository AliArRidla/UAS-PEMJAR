...
public class SocketThread implements Runnable {
    ...
    private void createConnection(String receiver, String sender, String filename) {
        try {
            ...
            } else {// Klientidak ada, kirim ulang penerima tidak ditemukan
                main.appendMessage("[createConnection]: Klien tidak ditemukan '" + receiver + "'");
                DataOutputStream dos = new DataOutputStream(socket.getOutputStream());
                dos.writeUTF("CMD_SENDFILEERROR " + "Client '" + receiver + "' tidak ditemukan dalam daftar, pastikan pengguna sedang online.!");
            }
        } catch (IOException e) {
                ...
                switch (CMD) {
                    ...
                    case "CMD_CHAT":
                        ...
                        try {
                            ...
                            main.appendMessage("[Message]: Dari " + from + " Tiba " + sendTo + " : " + msg);
                        } catch (IOException e) {
                    ...
                    case "CMD_SENDFILE":
                        ...
                        main.appendMessage("CMD_SENDFILE : Dari: " + consignee);
                        main.appendMessage("CMD_SENDFILE : Tiba: " + sendto);
                        /**
                         * Nhận client Socket *
                         */
                        main.appendMessage("CMD_SENDFILE : siap tersambung..");
                        ...
                        if (cSock != null) { /* Exists   */
                            ...
                            try {
                                main.appendMessage("CMD_SENDFILE : Terhubung..!");
                                /**
                                 * tulis nama file nya  *
                                 */
                                ...
                                /**
                                 * baca konten nya file nya di dalam   *
                                 */
                        ...
                        } else { /*   Jika tidak ada, return error  */
                            /*   FORMAT: CMD_SENDFILEERROR  */

                            main.removeClientFileSharing(consignee);
                            main.appendMessage("CMD_SENDFILE : Klien '" + sendto + "' tidak ditemukan.!");
                            DataOutputStream dos = new DataOutputStream(socket.getOutputStream());
                            dos.writeUTF("CMD_SENDFILEERROR " + "Klien '" + sendto + "' tidak ditemukan, Berbagi File akan keluar.");
                        }
                        break;
                    ...
                    case "CMD_SENDFILERESPONSE":
                         ...
                         */
                        String receiver = st.nextToken(); // method get penerima
                        String rMsg = ""; // method penerima kesalahan
                    ...
                    case "CMD_SEND_FILE_ERROR":  // Format:  CMD_SEND_FILE_ERROR [receiver] [Message]
                        ...
                        try {
                            /*  Kirim report jika ada kesalahan berbagi file  */
                            Socket eSock = main.getClientFileSharingSocket(eReceiver); // method get socket host nya untuk share file
                    ...
                    default:
                        main.appendMessage("[CMDException]: Perintah tidak diketahui " + CMD);
                        break;
                }
            }
        } catch (IOException e) {
            /*   ini dia fungsi chat client, hapus jika ada..   */
