...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setBackground(new java.awt.Color(139, 234, 185));
        jButton1.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jButton1.setText("Bergabung");
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/chaat.png"))); // NOI18N

        jLabel4.setFont(new java.awt.Font("Lucida Grande", 1, 18)); // NOI18N
        jLabel4.setText("Aplikasi Chat Sederhana");

        jLabel6.setText("UAS Pemjar");
    ...
    private void connectToServer(){
        if(txtHost.getText().length() > 0 && txtPort.getText().length() > 0 && txtUsername.getText().length() > 0){
            if(txtUsername.getText().length() <= 15){
                ...
                JOptionPane.showMessageDialog(this, "Akun harus maksimal 15 karakter termasuk [spasi].!","Error", JOptionPane.ERROR_MESSAGE);
            }
        } else {
            JOptionPane.showMessageDialog(this, "Form belum diisi!", "Kesalahan", JOptionPane.ERROR_MESSAGE);
        }
    }
