...
//    private String mydownloadfolder = "/Users/bee/NetBeansProjects/UASPEMJAR";
    /**
    ...
    public MainForm() {
        ...
        this.host = host;
        this.port = port;
        setTitle("Anda sedang login sebagai : " + username);
        // koneksi
        connect();
    }
     void MyInit(){
    ...
    public void connect(){
        appendMessage(" Menghubungkan...", "Status", Color.BLUE, Color.BLUE);
        try {
            socket = new Socket(host, port);
            dos = new DataOutputStream(socket.getOutputStream());
            // kirim nama pengguna yang ingin di hubungkan
            dos.writeUTF("CMD_JOIN "+ username);
            appendMessage(" Terhubung", "Status", Color.BLUE, Color.BLUE);
            appendMessage(" Kirim pesan sekarang!", "Status", Color.BLUE, Color.BLUE);
    ...
    */
    ...
    /*
        Tampilkan daftar saat ini online
    */
    ...
    */
    ...
    /*
        Fungsi ini akan membuka pemilih file
    */
    public void openFolder(){
        JFileChooser chooser = new JFileChooser();
        chooser.setFileSelectionMode(JFileChooser.DIRECTORIES_ONLY);
        int open = chooser.showDialog(this, "Folder terbuka");
    ...
    private void initComponents() {
        ...
        jButton1.setBackground(new java.awt.Color(32, 183, 246));
        ...
        jLabel1.setText("       Orang Online");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/chat-small.png"))); // NOI18N
    ...
    private void sendFileMenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendFileMenuActionPerformed
        ...
        if(!attachmentOpen){
            ...
            if(s.prepare(username, host, port, this)){
                ...
                JOptionPane.showMessageDialog(this, "Gagal menyiapkan Berbagi File saat ini, coba lagi nanti.!", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
    ...
    private void LogoutMenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LogoutMenuActionPerformed
        // TODO add your handling code here:
        int confirm = JOptionPane.showConfirmDialog(null, "Apakah kamu yakin untuk keluar?");
        if(confirm == 0){
            try {
                socket.close();
                setVisible(false);
    ...
    private void jTextField1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField1ActionPerformed
        ...
        try {
            ...
            appendMessage(" Tidak dapat mengirim pesan sekarang, tidak dapat terhubung ke Server saat ini, coba lagi nanti atau mulai ulang aplikasi ini.!", "Error", Color.RED, Color.RED);
        }
